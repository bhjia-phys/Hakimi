...
<!-- Dedicated `bash` tool card. Keeps the GenericTool rendering (row + chip +
     summary + expandable output). The web-preview affordance for local
     dev-server URLs printed by the command (e.g. `vite`/`npm run dev`
     printing `Local: http://localhost:5173/`) lives on the standalone
