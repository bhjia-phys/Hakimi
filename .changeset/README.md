...
1. Open each publishable package's page on the npm website, e.g. `https://www.npmjs.com/package/@bhjia-phys/hakimi`.
...
| Field | Value |
| --- | --- |
| GitHub Organization | `bhjia-phys` |
| GitHub Repository | `Hakimi` |
...
Once the changeset file is merged into `main`, `.github/workflows/release-hakimi.yml` uses `changesets/action@v1` to create or update a release PR.
