...
另一个作业观察恢复修复正在验证：已关闭的 Action 可以登记其既有外部作业的新观察，不重开 Action，也不改写原结论。这不授予轮询或新科研权限。证据与尚待完成的安装检查见[有界恢复切片](docs/aitp/theory-physics-collaborator-program.md#retained-run-recovery)。
