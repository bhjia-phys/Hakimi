 ...
 *    The deprecated `[secondary_model]` section is intentionally not included
 *    in this write: provider/model refresh must preserve its raw compatibility
 *    values exactly, even when a legacy alias no longer resolves.
