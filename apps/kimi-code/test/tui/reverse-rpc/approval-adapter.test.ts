  ...
  it('renders the /goal start menu for a CreateGoal approval in manual mode', () => {
    ...
    expect(adapted.choices).toEqual([
      ...
      },
      {
        ...
        selected_label: 'yolo',
        description:
          'Tools and plan changes are approved automatically. Hakimi may still ask you questions.',
      },
      {
        ...
        description:
          'Keep approvals on. Hakimi will ask before risky actions, so the goal may stop and wait for you.',
      },
      {
        label: 'Do not start',
        response: 'cancelled',
  ...
  it('renders the yolo-mode /goal start menu for a CreateGoal approval', () => {
    ...
    expect(adapted.choices).toEqual([
      ...
      },
      {
        ...
        selected_label: 'yolo',
        description:
          'Tools and plan changes stay approved automatically. Hakimi may still ask you questions.',
      },
      {
        label: 'Do not start',
        response: 'cancelled',
