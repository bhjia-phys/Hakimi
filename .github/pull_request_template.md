<!--
Thank you for your contribution to Hakimi!
Please open an issue before sending a feature PR — PRs without prior discussion may be closed without review.

See https://github.com/bhjia-phys/Hakimi/blob/main/CONTRIBUTING.md for more.
-->
...
<!-- What did you implement, and why does this approach fit Hakimi? -->

## Checklist

- [ ] I have read the [CONTRIBUTING](https://github.com/bhjia-phys/Hakimi/blob/main/CONTRIBUTING.md) document.
