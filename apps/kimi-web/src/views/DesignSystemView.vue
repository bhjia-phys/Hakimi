    ...
    <div class="layout">
      ...
      <aside class="sidebar">
        <div class="brand">
          ...
          <div class="brand-name">Hakimi Web</div>
        </div>
        ...
        <div class="content-inner">
          ...
          <section id="overview">
            <div class="hero">
              ...
              <h1>Hakimi Web <span class="grad">Design System</span></h1>
              <p class="lead">
                This document defines the visual language and component specification for Hakimi Web — design tokens, component primitives, the chat interface, theming, and style rules.
          ...
          <section id="principles">
            ...
            <p class="sec-desc">
              Every UI decision traces back to the following principles. Hakimi Web is a local Agent tool for developers: quick scanning, long stretches of staring, often in the dark — the design serves the task, and is restrained, clinical, and density-first.
            </p>
          ...
          <section id="tokens">
            ...
            <p>Hakimi Web uses two font families: <b>--font-ui</b> (UI and body, Inter first) and <b>--font-mono</b> (code and monospace). Components always reference the variables; do not hard-code font names.</p>
      ...
      ui-monospace, "SF Mono", Menlo, Consolas, monospace;</pre></div>
            ...
            <p>Do not use emoji as functional icons (the sole exception is the moon phases 🌑…🌘, used only in the "waiting for the Agent to respond" chat state). The Hakimi brand mark (the 32×22 cat-face logo) is a brand asset and is not part of this icon system.</p>
            ...
            <div class="callout info"><span class="ico">i</span><div>
              At ≤640px: dialogs become bottom Sheets, the sidebar gives way to a mobile top bar whose switcher and settings surfaces are bottom Sheets, and Composer toolbar controls are allowed to wrap.
            </div></div>
          </section>
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col">
                ...
                <div class="demo-row">
                  ...
                  <span class="p-badge solid">HAKIMI</span>
                </div>
    ...
    export function auth(token: string) {
      return verify(token, process.env.JWT_SECRET!);
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col">
                <div class="p-empty" style="width:100%;border:1px dashed var(--p-line);border-radius:var(--p-r-lg)">
                  ...
                  <div class="em-hint">Click "New chat" to start a conversation with Hakimi</div>
                </div>
              </div>
            </div>
          ...
          <section id="chat">
            ...
            <p class="sec-desc">
              The message stream is the core of Hakimi Web. The goal of the overhaul: have the 6 card types (Agent / Tool / Question / Approval / Swarm / Todo)
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col" style="align-items:center;background:#fff">
                <div class="p-composer" style="width:100%;max-width:620px">
                  <div class="p-composer-ta ph">Message Hakimi, / to run a command, @ to reference a file…</div>
            ...
            <div class="callout info"><span class="ico">i</span><div>
              At ≤640px: dialogs anchor to the bottom as Sheets (xl top radius, top drag handle), the sidebar is replaced by a mobile top bar with switcher / settings bottom Sheets, the Composer toolbar is allowed to wrap, and the chat reading column drops its max-width to fill the screen.
            </div></div>
          </section>
          ...
          <section id="themes">
            ...
            <p class="sec-desc">
              Hakimi Web uses <b>one unified theme</b>: the same components, fonts, radii, shadows, and surfaces — "reskinning" only changes colors.
          ...
          <section id="rules">
            ...
            <div class="callout good"><span class="ico">✓</span><div>
              The "🌑…🌘" moon-phase emoji are a brand signature of Hakimi Web, <b>used only in the chat state of "message sent, waiting for the Agent's first response"</b>, and are rendered uniformly by the <code>MoonSpinner</code> component; waiting states such as <code>ActivityNotice</code> reuse it rather than implementing their own moon phase.
            ...
            <div class="footer">
              <span>Hakimi Web Design System · v1.0</span>
    ...
    /*         sidebar ↑    ↑handle  ↑conversation  ↑handle ↑right panel (auto) */</pre></div>
            ...
            <table class="dt">
              ...
              <tbody>
                ...
                <tr><td>Quick-actions footer</td><td>stacked full-width left-aligned buttons (custom)</td><td>Provider Usage opens the shared usage Dialog; Settings opens configuration. The pinned group is separated from the session list by a 1px <code>--line</code> top border; both rows use icon + label and the same list-style family as New chat</td></tr>
              </tbody>
            </table>
            ...
            <p>The right panels (file preview / web preview / Diff / thinking / sub-agent / side chat) share one track and one head primitive.</p>
            <ul class="clean">
          ...
          <section id="a11y">
            ...
            <p class="sec-desc">
              Hakimi Web is a local developer tool; it <b>does not target a specific WCAG conformance level</b>, nor maintain a full screen-reader QA matrix.
