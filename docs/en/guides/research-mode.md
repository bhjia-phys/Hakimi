...
The expanded Board organizes the full research record into direction, current work, the research map, evidence and uncertainty, and operations or persistence. It preserves the complete period, bounded Research Plan, and status projection, and shows every available Research Line, Question, alert, evidence reference, uncertainty, checkpoint, run detail, and AITP maintenance item without silently replacing the remainder with an "additional items" count.
