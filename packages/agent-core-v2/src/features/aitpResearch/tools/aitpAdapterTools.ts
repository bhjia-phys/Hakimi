...
export class AitpRecordSaveTool implements IAitpRecordSaveTool {
  ...
  readonly description = 'Validate and save a prepared AITP Entry draft into the canonical ledger. The draft must already be filled in.';
