 ...
 * state machine until that review happens. Scope-agnostic.
 */
...
export interface ResearchEvidenceReview {
  ...
  readonly assessmentChanged: false;
  readonly nextOperations: readonly ['RecordResearchProgress', 'UpdateResearchQuestion'];
}
