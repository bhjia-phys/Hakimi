        ...
        let
          ...
          hakimi = pkgs.stdenv.mkDerivation (finalAttrs: {
            ...
            buildPhase = ''
              ...
              ''}
              # Nix derives the Web bundle from source before SEA collection.
              # Its pinned pnpm may lag the canonical version, so only this
              # sandbox opts into the explicit toolchain-mismatch bypass.
