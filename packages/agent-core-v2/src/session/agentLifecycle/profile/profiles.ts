...
const CODER_ROLE =
  ...
  'or worth follow-up. Respect the parent task’s requested length; a concise answer is ' +
  'sufficient when it contains the requested result, evidence, and limitations.';
